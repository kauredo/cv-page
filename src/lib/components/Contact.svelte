<script lang="ts">
	...
	const contacts = [
		{
			type: 'Email',
			href: 'mailto:vasco.kf@gmail.com',
			icon: 'M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z'
		},
		{
			type: 'GitHub',
			href: 'https://github.com/kauredo',
		...
		{
			type: 'LinkedIn',
			href: 'https://linkedin.com/in/vascokf',
...
<section
	class="rounded-3xl bg-gradient-to-br from-vasco-50 to-white p-8 dark:from-slate-800 dark:to-slate-800/50 sm:p-12"
		...
		<div use:inview={{ rootMargin: '0px', threshold: 0.2 }} on:inview_change={handleIntersect(1)}>
			{#if visibleItems[1]}
				<p
					...
					class="mb-8 text-slate-600 dark:text-slate-300"
				>
			...
			{#each contacts as contact, index}
				...
				>
					{#if visibleItems[index + 2]}
						<div in:fly={{ duration: 400, y: 20, delay: index * 100 }}>
							<Button type="secondary" href={contact.href} target_blank>
								{contact.type}
							</Button>
						</div>
					{/if}
